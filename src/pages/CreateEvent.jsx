        ...
        <div className="flex flex-col gap-8 sm:flex-row">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-6 flex gap-2">
              <div className="relative flex-1 divide-y divide-slate-200/70 rounded-2xl border border-slate-200/70 bg-white/60">
              ...
              <Popover
                ...
                trigger={({ open, toggle }) => (
                  <button
                    ...
                    onClick={toggle}
                    className={[
                      "flex w-32 shrink-0 flex-col items-start justify-center gap-1 rounded-2xl border border-slate-200/70 px-3 py-3 text-left transition",
            ...
            <Popover
              ...
              trigger={({ toggle }) => (
                <button
                  type="button"
                  onClick={toggle}
                  className="flex w-full items-center gap-3 rounded-2xl bg-slate-100/60 px-4 py-3 text-left transition hover:bg-slate-100"
                >
